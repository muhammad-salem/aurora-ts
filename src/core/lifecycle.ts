export interface OnChanges { onChanges(): void; }
export function isOnChanges(object: any): object is OnChanges { return 'onChanges' in object; }

export interface OnInit { onInit(): void; }
export function isOnInit(object: any): object is OnInit { return 'onInit' in object; }

export interface DoCheck { doCheck(): void; }
export function isDoCheck(object: any): object is DoCheck { return 'doCheck' in object; }
...
export function isOnDestroy(object: any): object is OnDestroy { return 'onDestroy' in object; }